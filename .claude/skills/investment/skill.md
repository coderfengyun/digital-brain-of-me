---
name: investment
description: "投资交易日志、盈亏计算、券商导入、投研作者管理。触发场景：交易记录（'交易记录', '更新交易', '导入交易'）；盈亏与持仓（'盈亏', '算算收益', '持仓', '仓位', 'P&L'）；券商（'币安', '富途', '招商证券', 'Binance', 'Futu'）；投研作者——提到 '洪灏'/'洪浩'/'卢麒元'/'卢麒元' 任何上下文都必须触发，包括简单的追加发言、记录观点、增加内容等看似简单的操作（因为 skill 包含索引更新和关键观点提取步骤，不能跳过）；触发词包括：'微博VIP群'、'发言'、'增加...发言'、'添加...发言'、'记录...观点'；研报（'研报', '微博研报', '下载微博', '最新文章'）。Note: image OCR is handled by the standalone 'ocr' skill."
---
