...
**Type**: Supplementary gist for the LLM Knowledge Bases tweet
...
- **Download images locally** - In Obsidian Settings, set attachment folder path and bind a hotkey for downloading attachments
