...
### work/
记录与杨元祖讨论时他表达的思考点（管理思路、业务判断、决策逻辑等）。
...
- **cultivation/** - 个人修行实践、体悟与阶段复盘。知识笔记回答“学到了什么”，cultivation 回答“如何实践并发生改变”。See [../cultivation/CULTIVATION.md](../cultivation/CULTIVATION.md)
...
- 可实践的修行方法先保留原始知识来源，再以引用方式登记到 cultivation；不要把外部观点直接当作个人体验
