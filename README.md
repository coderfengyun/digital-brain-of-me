...
├── cultivation/      # 个人修行：实践、体悟与阶段复盘
│   ├── CULTIVATION.md      # 模块入口与内容边界
│   └── cultivation.jsonl  # 修行主题和练习索引
...
4. **Track cultivation**: Add candidate practices to `cultivation/cultivation.jsonl`, then record real experience through weekly reviews and focused reflections
5. **Use with Claude Code**: Say things like "add a content idea about X", "周记", or "记录修行体悟"
...
各模块的详细说明见对应目录下的大写 `.md` 文件（如 `sources/SOURCES.md`、`knowledge/KNOWLEDGE.md`、`investment/INVESTMENT.md`、`weekly-review/WEEKLY-REVIEW.md`、`cultivation/CULTIVATION.md`）。
