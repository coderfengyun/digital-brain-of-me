...
**Author**: George Sivulka (@gsivulka), Founder & CEO of Hebbia
...
Concern around sociopolitical bias dominated AI discourse for years. The foundation model labs eventually circumvented the issue with enough RLHF to effectively turn all models into sycophants. Today, ChatGPT, Claude, etc. are so (overly) aligned that they'll agree with you on any topics within the Overton window.

The discourse on sociopolitical bias has died down. A new problem has taken its place.
...
Individual AI optimizes for usage. Institutional AI optimizes for edge.
...
But in the classic innovators' dilemma, depth beats breadth for specific applications every time:
...
We ask ourselves a question that sounds absurd but isn't: "What are the agents an AGI would choose to use as a shortcut? Even superintelligence would want purpose-built tools for specific domains."
...
> Naval @naval: "Pure software is rapidly becoming un-investable."
...
> Fig 11. There will be many chasms to cross for full organizational adoption. Each will have its challenges. Bringing processes online for AI across the entire organization will be a major driver.
...
Individual AI responds to human prompts. Institutional AI acts unprompted.
...
When you remove the need for humans to prompt AI, new interfaces and new ways of working emerge.

## Conclusion

None of this negates the need for chatbots, agents, and individual AI as a whole. Individual AI will be the vector by which the majority of the world's businesses first experience the transformative magic of AI. Driving for usage, and generalizable ease of use, is the key first step to the change management to build an AI first economy.
